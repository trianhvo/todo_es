...
const updateUserSchemaPath = path.resolve(__dirname, './schema/updateUserSchema.json')
const changePasswordSchemaPath = path.resolve(__dirname, './schema/changePasswordSchema.json')
...
const changePasswordSchema = JSON.parse(fs.readFileSync(changePasswordSchemaPath, 'utf8'));
